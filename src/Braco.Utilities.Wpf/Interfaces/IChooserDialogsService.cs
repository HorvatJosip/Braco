...
namespace Braco.Utilities.Wpf
{
    ...
    public interface IChooserDialogsService
    {
        ...
        string ChooseFile(string title, string selectedFile = null, params (string label, string extensions)[] filters);
		...
		IList<string> ChooseFiles(string title, string selectedFile = null, params (string label, string extensions)[] filters);
